...
public class EntityUtils {
    ...
    public static Entity spawnMobFromConfig(final FileConfiguration config, final String path, final Location location) {
        ...
        final ItemStack helmet = ItemUtils.getItem(config, path + ".Equipment.HELMET").parse();
        final ItemStack chestplate = ItemUtils.getItem(config, path + ".Equipment.CHESTPLATE").parse();
        final ItemStack leggings = ItemUtils.getItem(config, path + ".Equipment.LEGGINGS").parse();
        final ItemStack boots = ItemUtils.getItem(config, path + ".Equipment.BOOTS").parse();
        final ItemStack heldItem = ItemUtils.getItem(config, path + ".Held-Item").parse();
